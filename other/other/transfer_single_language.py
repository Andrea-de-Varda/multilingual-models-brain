...
# all_langs = ['Vietnamese', 'Japanese', 'Turkish', 'Tamil', 'Farsi', 'Marathi','Catalan', 'Spanish', 'Romanian', 'French', 'Lithuanian', 'Afrikaans', 'Dutch', 'English', 'Norwegian']
all_langs = ['Vietnamese', 'Turkish', 'Tamil', 'Farsi', 'Marathi', 'Spanish', 'Romanian', 'French', 'Lithuanian', 'Afrikaans', 'Dutch', 'Norwegian']
...
for lang in all_codes:
    weights = load_Ridge_weights(f"xlmr_large_{lang}_15")
