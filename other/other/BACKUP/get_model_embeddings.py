...
# ca = embeddings("ca", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
# ja = embeddings("ja", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
# en = embeddings("en", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
es = embeddings("es", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
mr = embeddings("mr", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
af = embeddings("af", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
vi = embeddings("vi", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
ta = embeddings("ta", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
lt = embeddings("lt", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
tr = embeddings("tr", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
nl = embeddings("nl", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True)
no = embeddings("no", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
fa = embeddings("fa", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
fr = embeddings("fr", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", special_replace = [('…', '...')], replace=True, emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
ro = embeddings("ro", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
# it = embeddings("ita", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_small", special_replace = [('—', '-')], replace=True, emb_start = 1, emb_end = -1, is_seq2seq = True)
...
# ca = embeddings("ca", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
# ja = embeddings("ja", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
# en = embeddings("en", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
es = embeddings("es", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
mr = embeddings("mr", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
af = embeddings("af", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
vi = embeddings("vi", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
ta = embeddings("ta", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
lt = embeddings("lt", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
tr = embeddings("tr", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
nl = embeddings("nl", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True)
no = embeddings("no", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
fa = embeddings("fa", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
fr = embeddings("fr", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", special_replace = [('…', '...')], replace=True, emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
ro = embeddings("ro", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", emb_start = 1, emb_end = -1, is_seq2seq = True, alternative_tok = True)
# it = embeddings("ita", sep = "▁", tokenizer = tokenizer, model = model, saveto = "m2m100_large", special_replace = [('—', '-')], replace=True, emb_start = 1, emb_end = -1, is_seq2seq = True)
