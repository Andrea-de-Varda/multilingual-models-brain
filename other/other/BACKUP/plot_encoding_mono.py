...
m2m100_smal = fullseries_r(all_codes, "m2m100_small", 12)
m2m100_larg = fullseries_r(all_codes, "m2m100_large", 24)
...
plot_md(best_layer_md, best_layer, "", ylim = .85, ylimstart = -.1, sig = p_values_best_md["asterisk"])
...
plot_md(best_layer_rh, best_layer, "", ylim = .85, ylimstart = -.1, sig = p_values_best_rh["asterisk"], name0 = "Right", name1 = "Left", color0 = "cornflowerblue", colname = "Hemisphere")
