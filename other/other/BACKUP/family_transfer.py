...
emb_rom = {lang : preproc_align(lang, load_embeddings(f"xlmr_large_{lang}", 16)) for lang in rom} # layer 16, best in transfer
emb_ger = {lang : preproc_align(lang, load_embeddings(f"xlmr_large_{lang}", 16)) for lang in ger}
emb_oth = {lang : preproc_align(lang, load_embeddings(f"xlmr_large_{lang}", 16)) for lang in oth}
