...
fig, axes = plt.subplots(20, 1, figsize=(10*.9, 24*.9))
yticks = [0, .5, 1]
...
plot_md(best_layer_multi_md, best_layer_multi, "", ylim = .65, ylimstart = -0.10, sig = p_values_best_md["asterisk"])
...
plot_md(best_layer_multi_rh, best_layer_multi, "", ylim = .75, ylimstart = 0, sig = p_values_best_rh["asterisk"], name0 = "Right", name1 = "Left", color0 = "cornflowerblue", colname = "Hemisphere")
